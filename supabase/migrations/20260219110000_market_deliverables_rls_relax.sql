-- Fallback unblock for seller uploads when strict RLS still denies inserts.
-- Keeps scope limited to market-deliverables bucket and seller-owned orders.
...
for select
to authenticated
using (bucket_id = 'market-deliverables');
...
for insert
to authenticated
with check (bucket_id = 'market-deliverables');
